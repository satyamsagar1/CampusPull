    ...
    <section className="py-16 bg-gradient-to-b from-white to-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {trendingResources?.map((resource) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-3 left-3">
                  <div className="flex items-center space-x-1 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1">
                    ...
                    <span className="text-xs font-inter font-medium text-academic-blue">
                      {resource?.type}
                    </span>
                  </div>
                </div>
              ...
              <div className="p-5">
                ...
                <p className="text-sm text-insight-gray font-inter mb-4">
                  {resource?.subject}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {resource?.tags?.slice(0, 3)?.map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-1 bg-surface text-xs font-inter font-medium text-insight-gray rounded-md"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <p className="text-xs font-inter font-medium text-wisdom-charcoal">
                        {resource?.author}
                      </p>
        ...
        <div className="text-center">
          <button className="inline-flex items-center space-x-2 px-8 py-3 bg-academic-blue hover:bg-blue-700 text-white font-inter font-medium rounded-lg shadow-brand-md hover:shadow-brand-lg transition-all duration-300">
